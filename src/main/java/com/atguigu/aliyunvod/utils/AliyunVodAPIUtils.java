package com.atguigu.aliyunvod.utils;
...
public class AliyunVodAPIUtils {
    ...
    //账号AccessKey信息请填写(必选)
    private static String access_key_id = "LTAI4Fgr2Nn7cVoHpfSARRAJ";
    //账号AccessKey信息请填写(必选)
    private static String access_key_secret = "E1g1Y1CtiwIWNRdkNtK4GMMSLQRQYJ";
    ...
    private static String generateURL(String domain, String httpMethod, Map<String, String> publicParams, Map<String, String> privateParams) {
       //将共有参数map和私有参数map进行了urlEncode编码
        // 并用=连接map集合中的key和value，放入List集合中
     ...
     * 获取CQS 的字符串
     *
     * @param allParams 所有的共有参数和私有参数组成的列表list
     * @return
     */
    private static String getCQS(List<String> allParams) {
        //将所有的私有参数和共有参数按ASCII排序
